 ...
 * @author andre
 */
public class ExcluirArticleChemical extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ExcluirArticleChemical</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ExcluirArticleChemical at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(conexaoBD.removerArticleChemical(articleID, chemical)){
    ...
    private String constroiPaginaSucesso(String articleID, String chemical) {
        ...
        pagina = "<!DOCTYPE html>\n"
                + "<html>\n"
                + "  <head>\n"
                + "    <title>Chemical Removido</title>\n"
                + "    <meta charset=\"UTF-8\">\n"
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>Chemical "+ chemical +" removido do artigo " + articleID + " com sucesso</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
    ...
    private String constroiPaginaErro(String articleID, String chemical) {
        ...
        pagina = "<!DOCTYPE html>\n"
                ...
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>O chemical "+chemical+" não pode ser removido do artigo " + articleID +"\n"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
