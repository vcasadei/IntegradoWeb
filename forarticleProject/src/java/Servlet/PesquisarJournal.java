 ...
 * @author Ian
 */
public class PesquisarJournal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PesquisarJournal</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PesquisarJournal at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        //recebe o title buscado na operação de busca pelo journal
        String title = request.getParameter("title");
                
        //Lista de journal encontrados
        ArrayList <Journal> journal;        
        ConexaoBD conexaoBD = new ConexaoBD();
        journal = conexaoBD.pesquisarJournal(title);
        ...
        if(journal.isEmpty()){
            ...
            retorno.print(this.constroiPaginaResultados(journal));
        }
    ...
    private String constroiPaginaResultados(ArrayList<Journal> journal){
        String pagina;
        pagina = "<!DOCTYPE html>\n"
                + "<html>\n"
                + "  <head>\n"
                ...
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>Foram encontrados : " + journal.size() + " resultados</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
