 ...
 * @author andre
 */
public class InserirArticleKeyWord extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InserirArticleKeyWord</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InserirArticleKeyWord at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(conexaoBD.inserirArticleKeyword(articleID, keyword)){
    ...
    private String constroiPaginaSucesso(String articleID, String keyword) {
        ...
        pagina = "<!DOCTYPE html>\n"
                + "<html>\n"
                + "  <head>\n"
                + "    <title>Keyword Associada</title>\n"
                + "    <meta charset=\"UTF-8\">\n"
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>Keyword "+ keyword +" adicionada ao artigo " + articleID + " com sucesso</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
    ...
    private String constroiPaginaErro(String articleID, String keyword) {
        ...
        pagina = "<!DOCTYPE html>\n"
                ...
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>A keyword "+keyword+" não pode ser associada ao artigo " + articleID +"\n"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
