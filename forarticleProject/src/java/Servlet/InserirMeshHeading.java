 ...
 * @author Ian
 */
public class InserirMeshHeading extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InserirMeshHeading</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InserirMeshHeading at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(conexaoBD.inserirMeshHeading(descriptionName)){
    ...
    private String constroiPaginaSucesso(String descriptionName) {
        ...
        pagina = "<!DOCTYPE html>\n"
                + "<html>\n"
                + "  <head>\n"
                + "    <title>MeshHeading Inserido</title>\n"
                + "    <meta charset=\"UTF-8\">\n"
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>MeshHeading " + descriptionName + " foi inserido com sucesso</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
    ...
    private String constroiPaginaErro(String descriptionName) {
        ...
        pagina = "<!DOCTYPE html>\n"
                ...
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>O meshHeading " + descriptionName + " não pode ser inserido</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
