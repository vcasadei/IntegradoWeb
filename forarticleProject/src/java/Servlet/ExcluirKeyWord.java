...
public class ExcluirKeyWord extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(conexaoBD.excluirKeyword(keyWordName)){
    ...
    private String constroiPaginaSucesso(String keyWordName) {
        ...
        pagina = "<!DOCTYPE html>\n"
                + "<html>\n"
                + "  <head>\n"
                + "    <title>Keyword  Excluido</title>\n"
                + "    <meta charset=\"UTF-8\">\n"
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>Keyword " + keyWordName + " foi exluído com sucesso</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
    ...
    private String constroiPaginaErro(String keyWordName) {
        ...
        pagina = "<!DOCTYPE html>\n"
                ...
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>A Keyword  " + keyWordName + " não pode ser excluído</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
