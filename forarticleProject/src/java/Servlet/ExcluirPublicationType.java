...
public class ExcluirPublicationType extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(conexaoBD.excluirPublicationType(typeName)){
    ...
    private String constroiPaginaSucesso(String typeName) {
        ...
        pagina = "<!DOCTYPE html>\n"
                + "<html>\n"
                + "  <head>\n"
                + "    <title>PublicationType  Excluido</title>\n"
                + "    <meta charset=\"UTF-8\">\n"
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>PublicationType " + typeName + " foi exluído com sucesso</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
    ...
    private String constroiPaginaErro(String typeName) {
        ...
        pagina = "<!DOCTYPE html>\n"
                ...
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>O PublicationType  " + typeName + " não pode ser excluído</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
