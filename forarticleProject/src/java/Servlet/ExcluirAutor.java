...
public class ExcluirAutor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ExcluirAutor</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ExcluirAutor at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(conexaoBD.excluirAuthor(foreName,lastName,initials)){
    ...
    private String constroiPaginaSucesso(String foreName, String lastName) {
        ...
        pagina = "<!DOCTYPE html>\n"
                + "<html>\n"
                + "  <head>\n"
                + "    <title>Autor Excluido</title>\n"
                + "    <meta charset=\"UTF-8\">\n"
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>Autor " + foreName + lastName + " foi exluído com sucesso</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
    ...
    private String constroiPaginaErro(String foreName, String lastName) {
        ...
        pagina = "<!DOCTYPE html>\n"
                ...
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>O Autor " + foreName + lastName + " não pode ser excluído</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
