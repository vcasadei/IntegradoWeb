...
public class ExcluirArtigo extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(conexaoBD.excluirArtigo(articleID)){
            retorno.print(this.constroiPaginaSucesso(articleID));
        }else{
            retorno.print(this.constroiPaginaErro(articleID));
        }
    ...
    private String constroiPaginaSucesso(String articleID) {
        ...
        pagina = "<!DOCTYPE html>\n"
                + "<html>\n"
                + "  <head>\n"
                + "    <title>Artigo Excluido</title>\n"
                + "    <meta charset=\"UTF-8\">\n"
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>Artigo " + articleID + " foi exluído com sucesso</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
    ...
    private String constroiPaginaErro(String articleID) {
        ...
        pagina = "<!DOCTYPE html>\n"
                ...
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>O artigo " + articleID + " não pode ser excluído</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
