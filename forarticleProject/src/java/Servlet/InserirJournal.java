 ...
 * @author Ian
 */
public class InserirJournal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InserirJournal</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InserirJournal at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(conexaoBD.inserirJournal(ISSN, title, abreviation, nlmUniqueID)){
    ...
    private String constroiPaginaSucesso(String nlmUniqueID) {
        ...
        pagina = "<!DOCTYPE html>\n"
                + "<html>\n"
                + "  <head>\n"
                + "    <title>Journal Inserido</title>\n"
                + "    <meta charset=\"UTF-8\">\n"
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>Journal " + nlmUniqueID + " foi inserido com sucesso</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
    ...
    private String constroiPaginaErro(String nlmUniqueID) {
        ...
        pagina = "<!DOCTYPE html>\n"
                ...
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>O Journal " + nlmUniqueID + " não pode ser inserido</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
