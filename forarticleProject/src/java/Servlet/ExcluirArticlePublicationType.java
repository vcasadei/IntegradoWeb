 ...
 * @author andre
 */
public class ExcluirArticlePublicationType extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RemoverArticlePublicationType</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RemoverArticlePublicationType at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(conexaoBD.removerArticlePublicationType(articleID, publicationType)){
    ...
    private String constroiPaginaSucesso(String articleID, String publicationType) {
        ...
        pagina = "<!DOCTYPE html>\n"
                + "<html>\n"
                + "  <head>\n"
                + "    <title>P-Type Removido</title>\n"
                + "    <meta charset=\"UTF-8\">\n"
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>Publication Type "+ publicationType +" removido do artigo " + articleID + " com sucesso</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
    ...
    private String constroiPaginaErro(String articleID, String publicationType) {
        ...
        pagina = "<!DOCTYPE html>\n"
                ...
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>O Publication Type "+publicationType+" não pode ser removido do artigo " + articleID +"\n"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
