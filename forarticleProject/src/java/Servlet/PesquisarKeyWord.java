 ...
 * @author Ian
 */
public class PesquisarKeyWord extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PesquisarKeyWord</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PesquisarKeyWord at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        //recebe o keyWordName do KeyWord buscado
        ...
        //realiza a busca e restorna os resultados para keyWord
        ArrayList <KeyWord> keyWord;
        keyWord = conexaoBD.pesquisarKeyWord(keyWordName);
        
        //se a lista estiver vazia nenhum resultado foi encontrado
        if(!keyWord.isEmpty()){
            retorno.print(this.constroiPaginaResultados(keyWord));
        }else{
    ...
    private String constroiPaginaResultados(ArrayList<KeyWord> keyWord){
        String pagina;
        pagina = "<!DOCTYPE html>\n"
                + "<html>\n"
                + "  <head>\n"
                ...
                + "  </head>\n"
                + "  <body>\n"
                + "     <p>Foram encontrados : " + keyWord.size() + " resultados</p>"
                + "  </body>\n"
                + "</html>\n";
        return pagina;
    }
