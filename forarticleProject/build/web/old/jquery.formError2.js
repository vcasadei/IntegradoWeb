      ...
      function( message, options)
      {
         ...
         function remove( options)
         {
            ...
            if( options.successImage.enabled)
            {
               ...
               {
                  var img = $( "<img class='successImage' style='position:absolute; right:-20px; top:-09px; z-index:9999; left:152px;' src='" + options.successImage.src + "' />");
         ...
         function show( options)
         {
            ...
            {
               this.wrap( $("<div class='inputContainer' style='position:relative; width:" + this.width() + "px; margin-top:-14px; margin-left: 4px; margin-bottom:-14px; '></div>"));
            }
